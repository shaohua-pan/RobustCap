# borrowed from https://github.com/mkocabas/PARE/blob/master/pare/dataset/occlusion.py
#!/usr/bin/env python
...
def test_usage():
    import matplotlib.pyplot as plt
    occluders = load_occluders(config.paths.occ_dir)
